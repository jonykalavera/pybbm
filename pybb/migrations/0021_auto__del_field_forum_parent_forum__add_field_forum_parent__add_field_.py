...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Forum.parent_forum'
        db.delete_column('pybb_forum', 'parent_forum_id')

        # Adding field 'Forum.parent'
        db.add_column('pybb_forum', 'parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['pybb.Forum']), keep_default=False)

        # Adding field 'Forum.lft'
        db.add_column('pybb_forum', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Forum.rght'
        db.add_column('pybb_forum', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Forum.tree_id'
        db.add_column('pybb_forum', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)

        # Adding field 'Forum.level'
        db.add_column('pybb_forum', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Forum.parent_forum'
        db.add_column('pybb_forum', 'parent_forum', self.gf('django.db.models.fields.related.ForeignKey')(related_name='child_forums', null=True, to=orm['pybb.Forum'], blank=True), keep_default=False)

        # Deleting field 'Forum.parent'
        db.delete_column('pybb_forum', 'parent_id')

        # Deleting field 'Forum.lft'
        db.delete_column('pybb_forum', 'lft')

        # Deleting field 'Forum.rght'
        db.delete_column('pybb_forum', 'rght')

        # Deleting field 'Forum.tree_id'
        db.delete_column('pybb_forum', 'tree_id')

        # Deleting field 'Forum.level'
        db.delete_column('pybb_forum', 'level')
    ...
    models = {
        ...
        'pybb.forum': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['pybb.Forum']"}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
