...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pybb_forum', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

        # Adding unique constraint on 'Forum', fields ['slug']
        db.create_unique('pybb_forum', ['slug'])

        # Changing field 'Topic.slug'
        db.alter_column('pybb_topic', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

        # Adding unique constraint on 'Topic', fields ['slug']
        db.create_unique('pybb_topic', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Topic', fields ['slug']
        db.delete_unique('pybb_topic', ['slug'])

        # Removing unique constraint on 'Forum', fields ['slug']
        db.delete_unique('pybb_forum', ['slug'])

        # Changing field 'Forum.slug'
        db.alter_column('pybb_forum', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'Topic.slug'
        db.alter_column('pybb_topic', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
