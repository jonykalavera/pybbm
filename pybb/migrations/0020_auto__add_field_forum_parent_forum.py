...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pybb_forum', 'parent_forum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_forums', null=True, to=orm['pybb.Forum']), keep_default=False)
    ...
    models = {
        ...
        'pybb.forum': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'parent_forum': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_forums'", 'null': 'True', 'to': "orm['pybb.Forum']"}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
